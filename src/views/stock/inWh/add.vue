    ...
    <el-form :model="addForm" :rules="rules" ref="addForm" label-width="110px" class="addForm search-form">
      ...
      <div class="app-container-box">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="收货人" prop="receiverUserId">
      ...
      <div class="app-container-box">
        ...
        <el-table
          ...
          <!-- <el-table-column label="金额(元)" prop="amount" width="140" :formatter="formatAmount"></el-table-column> -->
...
import { getWarehouseList, saveOtherStockIn, viewOtherStockIn, otherStockIn } from '@/api/psi'
  ...
  methods:{
    ...
    handleSubmit(form){
      this.$refs[form].validate((valid, props) => {
          ...
          saveOtherStockIn(param).then(res => {
    ...
    queryOtherStockIn(){
      ...
      viewOtherStockIn(param).then(res => {
        if(res.code == '200'){
