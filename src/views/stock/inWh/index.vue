  ...
  <div class="app-container">
    <el-form :inline="true" ref="searchForm" :model="searchForm" class="search-form app-container-box">
      <el-form-item prop="supplierId">
        <el-select v-model="searchForm.supplierId" placeholder="发货单位">
          <el-option
    ...
    <div class="app-container-box">
      ...
      <el-table :data="dataList" class="mbt-24" border v-loading="listLoading" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="入库单号" width="160" fixed="left" :show-overflow-tooltip="true">
        ...
        <el-table-column label="发货单位" width="150">
          <template slot-scope="{row}">
...
import { getOtherStockInList, delOtherStockIn } from '@/api/psi'
...
export default {
  ...
  methods:{
    ...
    getList(){
      ...
      getOtherStockInList(param).then(res => {
    ...
    handleBatchDel(id){
      ...
      if(this.multipleSelection.length>0){
        ...
        .then(_ => {
          ...
          delOtherStockIn(param).then(res => {
            this.listLoading = false
            if(res.code == '200'){
