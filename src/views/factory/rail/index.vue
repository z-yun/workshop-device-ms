  ...
  <div class="app-container">
    ...
    <div class="app-container-box">
      ...
      <el-table :data="dataList" class="mbt-24" border v-loading="listLoading" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="轨道名称" width="140" :show-overflow-tooltip="true">
          <template slot-scope="scope">
            {{ scope.row.name }}
          </template>
        </el-table-column>
        ...
        <el-table-column label="创建时间" prop="createTime" width="160px" sortable></el-table-column>
...
import { getRailList, delRail } from '@/api/factory'
    ...
    handleBatchDel(id){
      ...
      // if(this.multipleSelection.length>0){
        ...
        .then(_ => {
          ...
          // 	railIds.push(item.id)
          // })
          // let param = {railIds}
          let param = {
            railIds: [id]
          }
          delRail(param).then(res => {
            this.listLoading = false
            if(res.code == '200'){
