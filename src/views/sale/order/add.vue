  ...
  <div class="app-container detail">
    <el-form :model="addForm" :rules="rules" ref="addForm" label-width="110px" class="addForm search-form">
      ...
      <div class="app-container-box">
        <h4 class="title">{{$t('psi.saleInfo')}}</h4>
        <el-row>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item label="销售员" prop="purchaseUserId">
          ...
          <el-col :span="8">
            <el-form-item label="销售日期" prop="purchaseDate">
              <el-date-picker
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="客户采购订单号">
              <el-input v-model="addForm.purchaseOrderNo" placeholder="请输入" />
            </el-form-item>
          </el-col>
        </el-row>
      </div>
...
import { getWarehouseList, saveSaleOrder, viewSaleOrder } from '@/api/psi'
import selectGoods from './dialog/SelectGoods'
  ...
  data() {
    return {
      ...
      rules:{
        ...
        deliveryDate:[{ required: true, trigger: 'blur', message:this.$t('validate.required')}]
      },
      userList:[],
      supplierList:[],
      warehouseList:[],
